...
These are all available and are published by [Packt Publishing](https://www.packtpub.com/), apart from "[Monitoring and Management With Docker and Containers](https://thenewstack.io/identifying-collecting-container-data/)", which was published by [The New Stack](https://thenewstack.io/).
